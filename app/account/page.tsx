...
export default function AccountPage(){
  ...
  return <main className="page-shell account-page">
    ...
    {!draft&&!subscriptions.length&&<section className="empty-account"><h1>Подписок пока нет</h1><p>Выберите дни и блюда в разделе «30 дней неодинаковой еды».</p><Link href="/#subscription">Открыть подписку</Link></section>}
